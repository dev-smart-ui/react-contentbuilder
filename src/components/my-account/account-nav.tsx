  ...
  return (
    <nav className="flex flex-col pb-2 md:pb-6 border border-skin-base rounded-md overflow-hidden">
      {options.map((item) => {
        ...
        return (
          <Link key={item.slug} href={item.slug} className={`flex items-center cursor-pointer text-sm lg:text-15px text-skin-base py-3.5 px-3.5 xl:px-4 2xl:px-5 mb-1 hover:text-skin-primary ${
                mainPath === menuPath
